...
myApp.directive('inputNumber', function () {
  return {
    ...
    template: '<div class="input_number row">' + '<div class="col  button_wrap">' + '<div class="input_button left_button" on-touch="minusBuyCount()"><i class="ion-minus-round" ></i></div>' + '</div>' + '<div class="col text-center" on-touch="show()" >' + '<div  class="text-center number_value" ng-show="isshow">{{buyCount}}</div>' + '<input type="tel" class="number_value" ng-hide="isshow" ng-model="buyCount">' + '</div>' + '<div class="col text-right button_wrap">' + '<div class="input_button right_button" on-touch="plusBuyCount()"><i class="ion-plus-round" ></i></div>' + '</div>' + '</div>',
    link: function (scope, element, attrs, accordionController) {
      var _attrs = attrs;
      var myelement = element;
      scope.isshow = true;
      scope.show = function (mythis) {
        scope.isshow = false;  // mythis.focus();
      };
...
myApp.controller('TopicsCtrl', [
  ...
  'windowInfo',
  'price',
  function ($scope, $timeout, $ionicModal, $ionicSlideBoxDelegate, $ionicScrollDelegate, sj, windowInfo, price) {
    $scope.chartOption = sj.getChartOption(1);
    $scope.newprice = price.getPriceData();
    $scope.newprice.XAG1.changeType = 'up';
    $scope.myChart = { 'isShow': false };
